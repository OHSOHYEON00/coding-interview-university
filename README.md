...
- ### Arrays
    - [ ] About Arrays:
        ...
        - [X] [MDN Array](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array) (Description Part)
...
- ### Linked Lists
    ...
    - [ ] Implement (I did with tail pointer & without):
        ...
        - [X] erase(index) - removes node at given index and returns removed element
        - [X] value_n_from_end(n) - returns the value of the node at nth position from the end of the list
        - [X] reverse() - reverses the list
        - [X] remove_value(value) - removes the first item in the list with this value
        - [X] get_all() - get all elements in list
